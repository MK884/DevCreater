     ...
     <table class="table table-bordered" id="users-list">
       ...
       <tbody>
          ...
          <tr>
             ...
             <td><?php echo $user['motive']; ?></td>

             <?php if($user['status']==0):?>   
                <td>
                 <a href="<?php echo base_url('update/'.$user['id']);?>" class="btn btn-primary btn-sm">Accept</a>
                 <a href="<?php echo base_url('delete/'.$user['id']);?>" class="btn btn-danger btn-sm">Reject</a>
                </td>
                <?php else:?>
                    <td>
